...
class ResultDescriptionServiceTest implements WithAssertions {
    ...
    void givenService_whenGetResultDescriptionForDestinyByCategoryAndLanguage_thenReturnDescription() {
        ...
        var resultDescription = underTest.findResultDescriptionByCategoryAndLanguage(DESTINY.getCategory(), ENGLISH.getValue());
    ...
    void givenService_whenGetResultDescriptionForPersonalityByCategoryAndLanguage_thenReturnDescription() {
        ...
        var resultDescription = underTest.findResultDescriptionByCategoryAndLanguage(PERSONALITY.getCategory(), ENGLISH.getValue());
    ...
    void givenService_whenGetResultDescriptionForAttitudeByCategoryAndLanguage_thenReturnDescription() {
        ...
        var resultDescription = underTest.findResultDescriptionByCategoryAndLanguage(ATTITUDE.getCategory(), ENGLISH.getValue());
    ...
    void givenService_whenGetResultDescriptionForCharacterByCategoryAndLanguage_thenReturnDescription() {
        ...
        var resultDescription = underTest.findResultDescriptionByCategoryAndLanguage(NumerologyValue.Category.CHARACTER.getCategory(), ENGLISH.getValue());
    ...
    void givenService_whenGetResultDescriptionForSoulUrgeByCategoryAndLanguage_thenReturnDescription() {
        ...
        var resultDescription = underTest.findResultDescriptionByCategoryAndLanguage(SOUL_URGE.getCategory(), ENGLISH.getValue());
    ...
    void givenService_whenGetResultDescriptionForHiddenAgendaByCategoryAndLanguage_thenReturnDescription() {
        ...
        var resultDescription = underTest.findResultDescriptionByCategoryAndLanguage(HIDDEN_AGENDA.getCategory(), ENGLISH.getValue());
    ...
    void givenService_whenGetResultDescriptionForDivinePurposeByCategoryAndLanguage_thenReturnDescription() {
        ...
        var resultDescription = underTest.findResultDescriptionByCategoryAndLanguage(DIVINE_PURPOSE.getCategory(), ENGLISH.getValue());
    ...
    void givenService_whenGetResultDescriptionForPersonalYearByCategoryAndLanguage_thenReturnDescription() {
        ...
        var resultDescription = underTest.findResultDescriptionByCategoryAndLanguage(PERSONAL_YEAR.getCategory(), ENGLISH.getValue());
    ...
    void givenService_whenGetResultDescriptionForLoveCompatibilityByCategoryAndLanguage_thenReturnDescription() {
        ...
        var resultDescription = underTest.findResultDescriptionByCategoryAndLanguage(LOVE_COMPATIBILITY.getCategory(), ENGLISH.getValue());
